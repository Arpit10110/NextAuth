  ...
  <>
    ...
    <div className='flex justify-center items-center ' >
      <form onSubmit={handleSubmit} className='flex flex-col items-center justify-center gap-[1rem] w-[40%] px-[1rem] py-[2rem] bg-gray-800 mt-[5rem] rounded-[0.5rem] '  action=""> 
         ...
         <button className='  bg-gray-700 px-[3rem] py-[0.3rem] rounded-[0.3rem] text-[1.3rem] cursor-pointer '  type="submit">Login</button>   
         <h2>Don't have an account? <Link className='text-blue-500' href={"/signup"}>Singup</Link></h2>
      </form>
    </div>
  </>
  )
